...
(function () {
  ...
  const PERMISSIONS = {
    owner: { dashboard: 'edit', analytics: 'edit', inbox: 'edit', contacts: 'edit', channels: 'edit', leads: 'edit', products: 'edit', broadcasts: 'edit', agents: 'edit', flows: 'edit', billing: 'edit', system: 'edit', team: 'edit', settings: 'edit' },
    admin: { dashboard: 'edit', analytics: 'edit', inbox: 'edit', contacts: 'edit', channels: 'edit', leads: 'edit', products: 'edit', broadcasts: 'edit', agents: 'edit', flows: 'edit', billing: 'view', system: 'view', team: 'edit', settings: 'view' },
    agente: { dashboard: 'view', analytics: 'view', inbox: 'edit', contacts: 'edit', channels: null, leads: 'view', products: 'view', broadcasts: null, agents: null, flows: null, billing: null, system: null, team: null, settings: null },
    vendedor: { dashboard: 'view', analytics: 'view', inbox: 'edit', contacts: 'edit', channels: null, leads: 'view', products: 'view', broadcasts: 'edit', agents: null, flows: null, billing: null, system: null, team: null, settings: null },
  };
 ...
 /** @param {string} id — id de plataforma. @returns {object|undefined} */
  ...
  const ICONS = {
    ...
    'chevron-down': { paths: '<polyline points="6 9 12 15 18 9"/>' },
    'chevron-up': { paths: '<polyline points="18 15 12 9 6 15"/>' },
    ...
    sparkles: { paths: '<path d="M9.937 15.5A2 2 0 0 0 8.5 14.063l-6.135-1.582a.5.5 0 0 1 0-.962L8.5 9.936A2 2 0 0 0 9.937 8.5l1.582-6.135a.5.5 0 0 1 .963 0L14.063 8.5A2 2 0 0 0 15.5 9.937l6.135 1.581a.5.5 0 0 1 0 .964L15.5 14.063a2 2 0 0 0-1.437 1.437l-1.582 6.135a.5.5 0 0 1-.963 0z"/><path d="M20 3v4"/><path d="M22 5h-4"/><path d="M4 17v2"/><path d="M5 18H3"/>' },
    ...
    workflow: { paths: '<rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/><path d="M6.5 10v1.5A2.5 2.5 0 0 0 9 14h5"/><path d="M18 14v-2a2 2 0 0 0-2-2h-4"/>' },
  };
